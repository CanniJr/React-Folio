...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of designing and building Web and Mobile applications with JavaScript / React.js and some other cool libraries and frameworks."
  ),
  resumeLink:
